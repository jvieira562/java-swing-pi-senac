 ...
 */
package br.sp.senac.exemplojdbc.view;
...
public class TelaConsultaNotaFiscal extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!txtNumeroNota.getText().trim().isEmpty()) {
            int idNota = Integer.parseInt(txtNumeroNota.getText());
            NotaFiscal nf = new NotaFiscal();
            nf = NotaFiscalDAO.consultarPorID(idNota);
            model.setRowCount(0);
            model.addRow(new String[]{String.valueOf(nf.getIdNota()), String.valueOf(nf.getNumeroNota()), String.valueOf(nf.getValorNota())});
        } else {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        TelaCadastroNotaFiscal telaEditar;
        if(linhaSelecionada > 0){
            NotaFiscal nf = new NotaFiscal();
            nf.setIdNota(Integer.parseInt(tblNotas.getValueAt(linhaSelecionada, 0).toString()));
            nf.setNumeroNota(Integer.parseInt(tblNotas.getValueAt(linhaSelecionada, 1).toString()));
            nf.setValorNota(Double.parseDouble(tblNotas.getValueAt(linhaSelecionada, 2).toString()));
            telaEditar = new TelaCadastroNotaFiscal(nf);
